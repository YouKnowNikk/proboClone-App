...
const BidModel: React.FC<BidModelProps> = ({ yesPrice, noPrice, onClose, selectedButton, title, icon }) => {
    ...
    const setColor = preselectedButton === "yes" ? '#434ce7' : "#c75147";
